...
const AgentBox: React.FC<Props> = ({ agent }) => {
  return (
    <Link
      ...
      className="flex flex-col max-w-[400px] items-center border-2 hover:border-indigo-500 rounded-3xl bg-indigo-100
      hover:bg-indigo-400 transition hover:ease-in-out hover:duration-200 z-20 overflow-hidden"
    >
      <Image
